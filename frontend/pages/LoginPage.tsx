    ...
    <div className="min-h-[80vh] flex items-center justify-center px-6">
      <div className="w-full max-w-sm space-y-12 animate-fade-up">
        <div className="space-y-4 text-center">
          <h1 className="text-5xl font-black uppercase tracking-tighter italic">{t('login.title')}</h1>
          <p className="text-zinc-500 text-sm font-bold uppercase tracking-widest">{t('login.subtitle')}</p>
        </div>
        ...
        <div className="space-y-3 text-center">
          <p className="text-xs font-bold text-zinc-600 uppercase tracking-widest">
            {t('login.noAccount')}{' '}
            <Link to="/auth/register" className="text-white hover:text-accent ml-1 transition-colors">
